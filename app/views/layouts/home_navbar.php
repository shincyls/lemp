<nav class="navbar navbar-expand-lg navbar-dark bg-none">
  <div class="container-fluid">
    <a class="navbar-brand text-primary me-4" href="/home"><b><i class="fa fa-google"></i> HOMEPAGE</b><p class="breadcrumb-item text-xs text-white text-center p-0 m-0">My Slogan Here</p></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li>
          <div class="dropdown">
            <a href="/cronjob" class="nav-link text-white mx-1 my-0 dropdown-toggle" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
              <b>Cronjob</b>
            </a>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
              <li><a class="dropdown-item" href="/cronjob/jobs">Jobs</a></li>
              <li><a class="dropdown-item" href="/cronjob/logs">Logs</a></li>
            </ul>
          </div>
        </li>
      </ul>
