            ...
            <div class="col-8">
              <div class="numbers">
                ...
                <h5 class="font-weight-bolder">
                  <span id="home-sales">RM 100</span>
                </h5>
              </div>
            </div>
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-uppercase font-weight-bold">Places</p>
                <h5 class="font-weight-bolder">
                    <span id="home-places">100</span>
                </h5>
              </div>
            </div>
            <div class="col-4 text-end">
